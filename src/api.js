...
const isDevelopment = window.location.port === '3000' || window.location.port === '3001' || window.location.port === '3002' || window.location.port === '5173' || window.location.port === '3004' || window.location.port === '3005';
